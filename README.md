...
The `IVideoConversionService` interface defines the contract for video conversion operations including format conversion, metadata extraction, audio track manipulation, and format-specific transformations like converting to vertical Shorts format. It serves as the primary abstraction for video processing operations in the application, enabling consistent video encoding and format conversion across different use cases.
...
public class VideoConversionServiceDemo
{
