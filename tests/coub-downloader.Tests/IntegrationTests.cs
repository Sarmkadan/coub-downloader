...
/// <summary>
/// Contains integration tests that verify end-to-end functionality of the Coub downloader system.
/// Tests cover single video downloads, batch processing, and service interactions using mocked dependencies.
/// </summary>
public class IntegrationTests
{
	/// <summary>
	/// Service provider that creates instances of services with mocked dependencies.
	/// </summary>
	private readonly ServiceProvider _serviceProvider;
	/// <summary>
	/// Mock HttpMessageHandler for testing HTTP interactions with Coub API and video servers.
	/// </summary>
	...
	/// <summary>
	/// Mock logging service for testing logging behavior.
	/// </summary>
	...
	/// <summary>
	/// HttpClient instance with mocked message handler for testing HTTP interactions
	/// </summary>
	...
	/// Sets up mocked dependencies and service provider for integration testing.
	/// </summary>
	...
	/// <summary>
	/// Sets up the mock HttpMessageHandler to return a specific HTTP response.
	/// </summary>
	...
	/// <summary>
	/// Tests end-to-end single video download workflow.
	/// Verifies that a video can be downloaded from Coub, including metadata retrieval and file download.
	/// </summary>
	[Fact]
	...
	/// <summary>
	/// Tests end-to-end batch processing workflow.
	/// Verifies that multiple videos can be processed in batch mode, including job creation, task addition, and processing completion.
	/// </summary>
	[Fact]
